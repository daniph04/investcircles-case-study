...
Captured on **11 August 2026** from the running iOS app with a dedicated synthetic account. The media is unretouched apart from the simulator's own capture encoding.
